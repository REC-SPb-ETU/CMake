...
#  * Default   : "unknown"
#
# .. variable:: CPACK_RPM_DEBUGINFO_INSTALL
#
...
# This is a generated debuginfo package
if(CPACK_RPM_DEBUGINFO)
  if(CPACK_RPM_PACKAGE_DEBUG)
    message("CPackRPM:Debug: User defined more define spec line specified: ${CPACK_RPM_DEBUGINFO} \n")
  endif()
endif()

set(CPACK_DEBUGINFO ${CPACK_DEBUGINFO})

if(CPACK_DEBUGINFO)
    set(CPACK_RPM_DEBUGINFO "%debug_package")
endif()
